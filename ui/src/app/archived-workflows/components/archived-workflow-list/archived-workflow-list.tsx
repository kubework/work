import {Page, SlidingPanel} from 'work-ui';
...
export class ArchivedWorkflowList extends BasePage<RouteComponentProps<any>, State> {
    ...
    private renderWorkflows() {
        ...
        const learnMore = <a href='https://github.com/kubework/work/blob/master/docs/workflow-archive.md'>Learn more</a>;
        ...
        return (
            <>
                <div className='work-table-list'>
                    <div className='row work-table-list__head'>
                    ...
                    {this.state.workflows.map(w => (
                        <Link className='row work-table-list__row' key={`${w.metadata.uid}`} to={uiUrl(`archived-workflows/${w.metadata.namespace}/${w.metadata.uid}`)}>
                            <div className='columns small-1'>
                ...
                <p>
                    {this.state.offset !== 0 && (
                        <button
                            className='work-button work-button--base-o'
                            onClick={() => {

import { SlideContents, Utils as WorkUtils } from 'work-ui';
    ...
    private scrollToHighlightedStep() {
        if (this.props.selectedNode) {
            setTimeout(() => {
                ...
                if (viewerHighlight) {
                    const parent = WorkUtils.getScrollParent(viewerHighlight);
                    WorkUtils.scrollTo(parent, viewerHighlight.offsetTop + parent.scrollTop - window.pageYOffset - parent.clientHeight / 2);
                }
            });
        }
    }

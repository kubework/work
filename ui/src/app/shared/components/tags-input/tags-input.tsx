...
import {Autocomplete, AutocompleteApi, AutocompleteOption} from 'work-ui';
...
export class TagsInput extends React.Component<TagsInputProps, {tags: string[]; input: string; focused: boolean}> {
    ...
    public render() {
        return (
            <div
                className={classNames('tags-input work-field', {'tags-input--focused': this.state.focused || !!this.state.input})}

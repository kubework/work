                    ...
                    {(formikApi: any) => (
                        <form onSubmit={formikApi.handleSubmit}>
                            <div className='white-box editable-panel'>
                                ...
                                <button type='submit' className='work-button work-button--base' disabled={formikApi.isSubmitting || this.state.invalid}>
                                    Submit
                                </button>
                                {this.state.error && (
                                    <p>
                    ...
                    if (param != null) {
                        return (
                            <div className='work-form-row'>
                                <label className='work-label-placeholder' htmlFor={path + '.parameters[' + index + '].value'}>
                                    {param.name}
                                </label>
                                <input

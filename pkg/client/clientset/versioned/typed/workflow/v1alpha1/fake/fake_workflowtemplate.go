...
type FakeWorkflowTemplates struct {
	Fake *FakeKubeworkV1alpha1
	ns   string
}

var workflowtemplatesResource = schema.GroupVersionResource{Group: "kubework.io", Version: "v1alpha1", Resource: "workflowtemplates"}

var workflowtemplatesKind = schema.GroupVersionKind{Group: "kubework.io", Version: "v1alpha1", Kind: "WorkflowTemplate"}

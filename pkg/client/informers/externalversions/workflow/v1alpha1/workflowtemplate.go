...
import (
	...
	workflowv1alpha1 "github.com/kubework/work/pkg/apis/workflow/v1alpha1"
	versioned "github.com/kubework/work/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kubework/work/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kubework/work/pkg/client/listers/workflow/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeworkV1alpha1().WorkflowTemplates(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeworkV1alpha1().WorkflowTemplates(namespace).Watch(options)
			},
		},

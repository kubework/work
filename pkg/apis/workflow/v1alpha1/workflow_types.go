...
type WorkflowStep struct {
	...
	// ContinueOn makes work to proceed with the following step even if this step fails.
...
type DAGTemplate struct {
	...
	// More info and example about this feature at https://github.com/kubework/work/issues/1442

...
const (
	...
	PodMetadataMountPath = "/work/" + PodMetadataVolumeName
	...
	// Each artifact will be named according to its input name (e.g: /work/inputs/artifacts/CODE)
	ExecutorArtifactBaseDir = "/work/inputs/artifacts"
	...
	// EnvVarWorkTrace is used enable tracing statements in Work components
	EnvVarWorkTrace = "ARGO_TRACE"
	...
	SecretVolMountPath            = "/work/secret"
)

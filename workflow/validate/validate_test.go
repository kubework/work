...
var wftmplGetter = templateresolution.WrapWorkflowTemplateInterface(wfClientset.KubeworkV1alpha1().WorkflowTemplates(metav1.NamespaceDefault))
...
kind: Workflow
metadata:
  generateName: work-datadog-agent-
spec:
  entrypoint: main
  arguments:
    parameters:

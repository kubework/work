...
import (
	...
	art "github.com/kubework/work/workflow/artifacts/artifactory"
)

const (
	LoadFileName string = "work_artifactory_test_load.txt"
	SaveFileName string = "work_artifactory_test_save.txt"

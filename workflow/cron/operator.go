...
import (
	...
	typed "github.com/kubework/work/pkg/client/clientset/versioned/typed/workflow/v1alpha1"
...
func newCronWfOperationCtx(cronWorkflow *v1alpha1.CronWorkflow, wfClientset versioned.Interface, wfLister util.WorkflowLister) (*cronWfOperationCtx, error) {
	return &cronWfOperationCtx{
		...
		wfClient:    wfClientset.KubeworkV1alpha1().Workflows(cronWorkflow.Namespace),
		wfLister:    wfLister,
		cronWfIf:    wfClientset.KubeworkV1alpha1().CronWorkflows(cronWorkflow.Namespace),
	}, nil
}

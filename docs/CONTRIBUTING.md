...
To install into the “work” namespace of your cluster: Work, MinIO (for saving artifacts and logs) and Postgres (for offloading or archiving):
...
* Work on http://localhost:2746 (see below)
...
If you want to run controller or work-server in your IDE (e.g. so you can debug it):

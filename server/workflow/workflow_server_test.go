...
import (
	...
	"github.com/kubework/work/persist/sqldb/mocks"
	workflowpkg "github.com/kubework/work/pkg/apiclient/workflow"
	"github.com/kubework/work/pkg/apis/workflow/v1alpha1"
	v1alpha "github.com/kubework/work/pkg/client/clientset/versioned/fake"
...
const wf1 = `
{
    ...
    "metadata": {
        ...
        "labels": {
            ...
            "workflows.kubework.io/phase": "Succeeded"
        },
        "name": "hello-world-9tql2",
        "namespace": "workflows",
        "resourceVersion": "53020772",
        "selfLink": "/apis/kubework.io/v1alpha1/namespaces/workflows/workflows/hello-world-9tql2",
...
const wf2 = `
{
    ...
    "metadata": {
        ...
        "selfLink": "/apis/kubework.io/v1alpha1/namespaces/workflows/workflows/hello-world-b6h5m",
...
const wf5 = `
{
    ...
    "metadata": {
        ...
        "generation": 5,
        "labels": {
            "workflows.kubework.io/completed": "false",
